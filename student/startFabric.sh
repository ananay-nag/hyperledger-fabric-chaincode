...
# CC_CHANNEL_NAME="student"
CC_SRC_LANGUAGE=`echo "$CC_SRC_LANGUAGE" | tr [:upper:] [:lower:]`
CC_SRC_PATH="../chaincode/student/typescript/"
# echo $CC_SRC_PATH
...
./network.sh deployCC -ccn student -ccv 1 -cci initLedger -ccl ${CC_SRC_LANGUAGE} -ccp ${CC_SRC_PATH}
popd
